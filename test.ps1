...
$Uri = 'https://dev.azure.com/breento-devops/test/_apis/git/repositories/test/items?path=OSDCloud/02-Start-BreentoOSDCloud.ps1&download=true&api-version=6.0'
